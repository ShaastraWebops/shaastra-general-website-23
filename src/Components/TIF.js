...
function Tif() {
  return (
    <body>
      ...
      <div className="App">
        <div className="first-box">
          <div className="title">
            ...
            <p>
              <a href="https://tif.shaastra.org">Visit our website</a>
            </p>
          </div>
          <div className="content1">
            <p>
              The event helps the participants to take their tech-based
              prototype to the next level by converting it into an MVP
              (Minimum-viable product).These benchmark models can further be
              incubated for the commencement of a start-up.
            </p>
          </div>
        </div>
        <div className="content2">
          <p>
            ...
            Shaastra where they will exhibit their product to the massive crowd
            of Shaastra.The event concludes with the final pitching competition
            which takes place at IITM research park. By the end of the event,
        ...
        {/* <div className="fourth-box">
          <div className="title">
            <h3 className="headers">
              Exhibitions And
              <span className="seminar"> Research Park Visit</span>
            </h3>
          </div>
      ...
      <Footer
        designed={[
          { name: "Jainav", mail: "mailto:ce21b062@smail.iitm.ac.in " },
        ]}
      />
    </body>
  );
