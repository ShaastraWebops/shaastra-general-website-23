            ...
            <section className="debunk-section">
                ...
                <div className="aboutdebunk">
                    ...
                    <p>
                        ...
                        are all fabricated information, designed to manipulate our thoughts and decisions. The world is witnessing a rapid rise in news stories that are high on emotion and low on facts; leaving us often confused on whether we must raise an eyebrow, or raise our voices. Major media and tech organizations like Google and WhatsApp have invested over $300 million into combating fake news, in addition to the many activists, NGOs and interest groups supporting the cause. So this year, we at Shaastra (started /initiated) 'Debunk', a brand-new initiative by Shaastra to increase media literacy, dismantle myths, dissolve delusions and eliminate illusions.
                ...
                <div className="debunkinit">
                    ...
                    <div className="debin debin2">
                        ...
                        <div>
                            <p>
                                Debunk in partnership with BOOM (one of India’s first and leading fact-checking initiatives) also conducted a series of workshops on digital media literacy and fact-checking in October for the general public, particularly the youth. With an attendance of over 1000 participants, the workshops were successful in imparting critical thinking and observational skills – both key elements required for identifying fake news – through engaging games, quizzes, and other activities.
                            </p></div>
                    </div>
